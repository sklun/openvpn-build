...
java -jar %JsignJar%^
 ...
 ..\src\openvpn\out\build\win-%SignArch%-release\Release\*.exe^
 ..\src\openvpn\out\build\win-%SignArch%-release\Release\*.dll^
 ..\src\openvpn\out\build\win-%SignArch%-release\src\openvpnmsica\Release\*.exe^
